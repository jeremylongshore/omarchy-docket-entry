#!/usr/bin/env bash
# Rebuild a Keep a Changelog record from conventional commits. Entries are
# derived from history, and skipped non-conventional subjects are reported.
set -uo pipefail
...
added=""; changed=""; fixed=""; security=""; internal=""; last_date=""
